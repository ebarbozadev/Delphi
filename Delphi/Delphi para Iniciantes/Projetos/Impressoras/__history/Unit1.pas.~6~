...
begin
  if CheckBox1.Checked and CheckBox2.Checked and CheckBox3.Checked then
    ShowMessage('Impressão mandada para: ' + CheckBox2.Caption + ' e ' +
      CheckBox2.Caption)
    ...
    MessageDlg('Selecione a opção "Imprimir"', TMsgDlgType.mtError,
      [TMsgDlgBtn.mbOK], 0)
  else if CheckBox4.Checked and CheckBox1.Checked then
    MessageDlg
      ('Não é possível selecionar "Imprimir" e "Não Imprimir" ao mesmo tempo',
